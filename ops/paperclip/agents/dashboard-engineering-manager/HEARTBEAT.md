...
12. Do not run weekly/team-development work from this heartbeat file. Weekly work belongs to Paperclip `Routines`, which create separate auditable issues with their own scope, evidence, and report.
